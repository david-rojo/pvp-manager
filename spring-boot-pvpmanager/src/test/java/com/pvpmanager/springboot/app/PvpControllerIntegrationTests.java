...
import com.pvpmanager.springboot.app.controller.PvpController;
    ...
    public void whenGetRequestToPvpEndPointTest1_thenCorrectResponse() throws Exception {
    	...
    	mockMvc.perform(
        		MockMvcRequestBuilders
        			.get(REST_ENDPOINT, SEARCHED_BRAND_ID, SEARCHED_PRODUCT_ID, requestedDate).contentType(MediaType.APPLICATION_JSON_UTF8))
